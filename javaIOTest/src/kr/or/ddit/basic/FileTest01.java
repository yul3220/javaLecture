...
public class FileTest01 {
	public static void main(String[] args) {
		...
		//		==> 디렉토리의 디렉토리 사이 또는 디렉토리와 파일명 사이의
		...
		System.out.println();
		//만들어지지 않음 => 중간에 있는 test/java가 d_other가 존재하지 않음
		//src를 만들기 위해서는 앞의 것들이 존재해야지 만들어진다.
	}
}
