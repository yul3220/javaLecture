...
/*
 	...
 	==> 읽어올 파일의 확장자는 반드시 properties이여야 하고
 		파일 내용을 'key값 = value값'형태로 되어 있어야 한다.
 */
...
public class ResourceBundleTest {
	public static void main(String[] args) {
		...
		//파일의 이름만 작성했음 => properties는 작성하지 않아도 된다.
		
//		ResourceBundle bundle = 
//		ResourceBundle.getBundle("dbinfo");
		
		ResourceBundle bundle = ResourceBundle.getBundle("kr/or/ddit/util/dbinfo2");
		// 
		...
		//try-catch문을 사용하지 않아도 되고 간단하게 작성할 수 있다.
	}
}
